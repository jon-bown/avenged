...
a7x_data = pd.DataFrame(a7x_data, columns = cols)        



#Check if new data added
prev_song_data = pd.read_csv('./data/avenged_songs.csv')

SAME = prev_song_data.equals(a7x_data)

#if not the same, update
if not SAME:
    a7x_data.to_csv('./data/avenged_songs.csv', index=False)
